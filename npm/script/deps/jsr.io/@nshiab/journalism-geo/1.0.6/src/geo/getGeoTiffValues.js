...
exports.default = getGeoTiffValues;
/**
 ...
 * @category Geo
 */
async function getGeoTiffValues(lat, lon, geoTiffDetails) {
    const { image, bbox, pixelWidth, pixelHeight, bboxWidth, bboxHeight } = geoTiffDetails;
