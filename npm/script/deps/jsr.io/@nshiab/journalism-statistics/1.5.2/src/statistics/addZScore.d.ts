 ...
 * @category Statistics
 */
export default function addZScore<T extends Record<string, unknown>, K extends string>(data: T[], variable: string, options: {
    newKey: K;
}): (T & {
    [P in K]: number;
})[];
 ...
 */
export default function addZScore<T extends Record<string, unknown>>(data: T[], variable: string, options?: {
    newKey?: undefined;
}): (T & {
    zScore: number;
})[];
//# sourceMappingURL=addZScore.d.ts.map