 ...
 * @category Statistics
 */
export default function getSampleSizeProportion(populationSize: number, confidenceLevel: 90 | 95 | 99, marginOfError: number): number;
//# sourceMappingURL=getSampleSizeProportion.d.ts.map