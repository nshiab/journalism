...
exports.default = addSheetRows;
const cleanData_js_1 = __importDefault(require("./helpers/cleanData.js"));
const logToSheet_js_1 = __importDefault(require("./helpers/logToSheet.js"));
/**
 ...
 * @category Google
 */
async function addSheetRows(data, sheetUrl, options = {}) {
    const sheet = await (0, logToSheet_js_1.default)(sheetUrl, options);
    const headerRow = Object.keys(data[0]);
    await sheet.setHeaderRow(headerRow, typeof options.headerIndex === "number" ? options.headerIndex + 1 : 1);
    await sheet.addRows((0, cleanData_js_1.default)(data), { raw: options.raw });
}
