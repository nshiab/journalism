...
exports.default = overwriteSheetData;
 ...
 * @category Google
 */
async function overwriteSheetData(data, sheetUrl, options = {}) {
    ...
    if (options.lastUpdate) {
        ...
        if (typeof options.timeZone === "string") {
            cellDate.value = (0, index_js_1.formatDate)(new Date(), "YYYY-MM-DD HH:MM:SS TZ", {
