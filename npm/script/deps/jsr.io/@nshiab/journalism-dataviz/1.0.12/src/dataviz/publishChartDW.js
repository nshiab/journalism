...
exports.default = publishChartDW;
 ...
 * @category Dataviz
 */
async function publishChartDW(chartId, options = {}) {
    ...
    if (response.status !== 200) {
        throw new Error(`publishChartDW ${chartId}: Upstream HTTP ${response.status} - ${response.statusText}`);
    }
}
