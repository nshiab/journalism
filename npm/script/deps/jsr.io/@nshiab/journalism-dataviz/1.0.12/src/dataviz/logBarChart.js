...
exports.default = logBarChart;
const index_js_1 = require("../../../../journalism-format/1.1.7/src/index.js");
const makeBars_js_1 = __importDefault(require("./helpers/makeBars.js"));
/**
 ...
 * @category Dataviz
 */
function logBarChart(data, labels, values, options = {}) {
    if (options.title) {
        console.log(`\n${options.title}`);
    }
    else {
    ...
    const formatValues = options.formatValues ??
        function (d) {
            return (0, index_js_1.formatNumber)(d);
        };
    const width = options.width ?? 40;
    const chartData = (0, makeBars_js_1.default)(data, "\x1b[38;5;55m", // Darker purple color
    String(labels), String(values), (d) => formatLabels(d), (d) => formatValues(d), width, options.compact ?? false, options.totalLabel);
