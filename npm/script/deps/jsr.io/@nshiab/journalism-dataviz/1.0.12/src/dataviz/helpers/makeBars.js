 ...
 */
function makeBars(data, color, labels, values, formatLabels, formatValues, width, compact, totalLabel) {
    const chartData = [];
    ...
    for (let i = 0; i < labelsData.length; i++) {
        ...
        chartData.push(labelsData[i] +
            ...
            " " +
            grey +
            (0, index_js_1.formatNumber)((valuesData[i] / sumVal) * 100, {
                decimals: 2,
                suffix: "%",
            }) +
            reset);
