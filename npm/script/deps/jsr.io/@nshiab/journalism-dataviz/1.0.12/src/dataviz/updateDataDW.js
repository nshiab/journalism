 ...
 * @category Dataviz
 */
async function updateDataDW(chartId, data, options = {}) {
    ...
    if (response.status !== 204) {
        throw new Error(`updateDataDW ${chartId}: Upstream HTTP ${response.status} - ${response.statusText}`);
    }
}
