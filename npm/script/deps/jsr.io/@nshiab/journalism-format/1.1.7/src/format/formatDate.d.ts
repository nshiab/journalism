 ...
 * @category Formatting
 */
export default function formatDate(date: Date, format: "YYYY-MM-DD" | "YYYY-MM-DD HH:MM:SS TZ" | "DayOfWeek, Month Day" | "Month DD" | "Month DD, HH:MM period" | "Month DD, HH:MM period TZ" | "DayOfWeek, HH:MM period" | "DayOfWeek, HH:MM period TZ" | "Month DD, YYYY" | "Month DD, YYYY, at HH:MM period" | "Month DD, YYYY, at HH:MM period TZ" | "DayOfWeek" | "Month" | "YYYY" | "MM" | "DD" | "HH:MM period" | "HH:MM period TZ" | "HH:MM period TZ on Month DD, YYYY" | "HH:MM period on Month DD, YYYY" | "HH:MM period TZ on Month DD" | "HH:MM period on Month DD", options?: {
    utc?: boolean;
    style?: "cbc" | "rc";
