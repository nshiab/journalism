...
const transformPositionToCbcStyle_js_1 = require("./helpers/transformPositionToCbcStyle.js");
const transformPositionToRcStyle_js_1 = require("./helpers/transformPositionToRcStyle.js");
/**
...
function formatNumber(number, options = {}) {
    ...
    if (options.position === true) {
        if (options.style === "rc") {
            return (0, transformPositionToRcStyle_js_1.transformPositionToRcStyle)(number);
        }
        else {
            return (0, transformPositionToCbcStyle_js_1.transformPositionToCbcStyle)(number);
        }
    }
    const mergedOptions = {
        style: "cbc",
    ...
    if (mergedOptions.round ||
        ...
        number = (0, round_js_1.default)(number, {
