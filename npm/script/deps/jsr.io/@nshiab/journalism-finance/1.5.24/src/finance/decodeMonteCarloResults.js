...
exports.decodeMonteCarloMonthlyIterations = decodeMonteCarloMonthlyIterations;
exports.decodeMonteCarloValues = decodeMonteCarloValues;
exports.decodeMonteCarloMonthlyQuantiles = decodeMonteCarloMonthlyQuantiles;
exports.decodeMonteCarloWinners = decodeMonteCarloWinners;
const simulateRentVsBuyMonteCarlo_js_1 = require("./simulateRentVsBuyMonteCarlo.js");
/**
 ...
 */
function decodeMonteCarloMonthlyIterations(c) {
 ...
 */
function decodeMonteCarloValues(c) {
    const { data, rows, cols, keys } = c;
    const result = new Array(keys.length * rows * cols);
    let idx = 0;
 ...
 */
function decodeMonteCarloMonthlyQuantiles(c, quantiles) {
 ...
 */
function decodeMonteCarloWinners(w) {
    ...
    for (let i = 0; i < length; i++) {
        result[i] = {
            ...
            amount: w.amount[i],
            category: simulateRentVsBuyMonteCarlo_js_1.WINNER_CATEGORIES[w.category[i]],
        };
    }
    return result;
}
