...
exports.default = simulateRentVsBuy;
const computeBalances_js_1 = __importDefault(require("./helpers/rentVsBuy/computeBalances.js"));
const computeExpenses_js_1 = __importDefault(require("./helpers/rentVsBuy/computeExpenses.js"));
const computeGains_js_1 = __importDefault(require("./helpers/rentVsBuy/computeGains.js"));
const computeSale_js_1 = __importDefault(require("./helpers/rentVsBuy/computeSale.js"));
const getPersona_js_1 = __importDefault(require("./helpers/rentVsBuy/getPersona.js"));
const incrementParameters_js_1 = __importDefault(require("./helpers/rentVsBuy/incrementParameters.js"));
const precomputeMortgagePayments_js_1 = __importDefault(require("./helpers/rentVsBuy/precomputeMortgagePayments.js"));
const toResults_js_1 = __importDefault(require("./helpers/rentVsBuy/toResults.js"));
const mortgageInsurancePremium_js_1 = __importDefault(require("./mortgageInsurancePremium.js"));
const getMinimumDownPayment_js_1 = __importDefault(require("./getMinimumDownPayment.js"));
const getSalesTax_js_1 = __importDefault(require("./getSalesTax.js"));
const getLandTransferTax_js_1 = __importStar(require("./getLandTransferTax.js"));
/**
 ...
 * ```
 */
function simulateRentVsBuy(parameters, options = {}) {
    const results = [];
    ...
    const province = (0, getLandTransferTax_js_1.getProvinceFromCity)(parameters.city);
    const downPaymentMin = (0, getMinimumDownPayment_js_1.default)(parameters.buyer.purchasePrice);
    ...
    const renter = (0, getPersona_js_1.default)({
    ...
    const insurancePremium = (0, mortgageInsurancePremium_js_1.default)(parameters.buyer.purchasePrice, parameters.buyer.downPayment);
    const landTransferTax = (0, getLandTransferTax_js_1.default)(parameters.city, parameters.buyer.purchasePrice, 2026, parameters.buyer.firstTimeOwner);
    const buyerFixed = (0, getPersona_js_1.default)({
    ...
    const buyerVariable = (0, getPersona_js_1.default)({
        startingMonthlyRent: 0,
        securityDeposit: 0,
        startingMonthlyInsurance: parameters.buyer.startingMonthlyInsurance,
        downPayment: parameters.buyer.downPayment,
    ...
    const salesTaxMultiplier = (0, getSalesTax_js_1.default)(10000, province, 2025).totalTax /
        10000;
    ...
    for (let monthIndex = 0; monthIndex < numberOfMonths; monthIndex++) {
        ...
        const { totalMonthlyExpenses: renterTotalMonthlyExpenses, } = (0, computeExpenses_js_1.default)(monthIndex, renter, null);
        const { totalMonthlyExpenses: buyerFixedTotalMonthlyExpenses, } = (0, computeExpenses_js_1.default)(monthIndex, buyerFixed, currentFixedMortgagePayment);
        const { totalMonthlyExpenses: buyerVariableTotalMonthlyExpenses, } = (0, computeExpenses_js_1.default)(monthIndex, buyerVariable, currentVariableMortgagePayment);
        ...
        (0, computeGains_js_1.default)(year, renter, null, currentMarketReturnRate, renterTotalMonthlyExpenses, maxMonthlyExpenses, parameters.tfsaContributions, parameters.couple, parameters.annualInvestmentFeeRate);
        (0, computeGains_js_1.default)(year, buyerFixed, currentFixedMortgagePayment, currentMarketReturnRate, buyerFixedTotalMonthlyExpenses, maxMonthlyExpenses, parameters.tfsaContributions, parameters.couple, parameters.annualInvestmentFeeRate);
        (0, computeGains_js_1.default)(year, buyerVariable, currentVariableMortgagePayment, currentMarketReturnRate, buyerVariableTotalMonthlyExpenses, maxMonthlyExpenses, parameters.tfsaContributions, parameters.couple, parameters.annualInvestmentFeeRate);
        ...
        (0, computeSale_js_1.default)(monthIndex, renter, parameters.values.employmentIncome[monthIndex], null, null, null, options.winVariableOnly ?? false, numberOfMonths, province, parameters.couple, salesTaxMultiplier);
        (0, computeSale_js_1.default)(monthIndex, buyerFixed, parameters.values.employmentIncome[monthIndex], currentFixedMortgagePayment, flooredRatesFixed, "fixed", options.winVariableOnly ?? false, numberOfMonths, province, parameters.couple, salesTaxMultiplier);
        (0, computeSale_js_1.default)(monthIndex, buyerVariable, parameters.values.employmentIncome[monthIndex], currentVariableMortgagePayment, flooredRatesVariable, "variable", options.winVariableOnly ?? false, numberOfMonths, province, parameters.couple, salesTaxMultiplier);
        // We compute the balances
        (0, computeBalances_js_1.default)(renter, options.winVariableOnly ?? false, monthIndex, numberOfMonths);
        (0, computeBalances_js_1.default)(buyerFixed, options.winVariableOnly ?? false, monthIndex, numberOfMonths);
        (0, computeBalances_js_1.default)(buyerVariable, options.winVariableOnly ?? false, monthIndex, numberOfMonths);
        // We push all results for this month
        (0, toResults_js_1.default)("renter", renter, results, monthIndex, numberOfMonths, options.winVariableOnly ?? false, null, parameters.values.employmentIncome[monthIndex], inflationMultiplier, options.onRecord, options.winVariable, options.groups);
        (0, toResults_js_1.default)("buyerFixed", buyerFixed, results, monthIndex, numberOfMonths, options.winVariableOnly ?? false, currentFixedMortgagePayment, parameters.values.employmentIncome[monthIndex], inflationMultiplier, options.onRecord, options.winVariable, options.groups);
        (0, toResults_js_1.default)("buyerVariable", buyerVariable, results, monthIndex, numberOfMonths, options.winVariableOnly ?? false, currentVariableMortgagePayment, parameters.values.employmentIncome[monthIndex], inflationMultiplier, options.onRecord, options.winVariable, options.groups);
        // We increment the parameters for next month
        (0, incrementParameters_js_1.default)(monthIndex, renter, parameters.rates);
        (0, incrementParameters_js_1.default)(monthIndex, buyerFixed, parameters.rates);
        (0, incrementParameters_js_1.default)(monthIndex, buyerVariable, parameters.rates);
