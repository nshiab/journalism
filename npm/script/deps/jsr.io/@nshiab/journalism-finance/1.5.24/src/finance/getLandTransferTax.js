...
exports.getProvinceFromCity = getProvinceFromCity;
exports.default = getLandTransferTax;
 ...
 */
function getLandTransferTax(city, propertyValue, year, firstTimeOwner = false) {
    if (year !== 2026) {
