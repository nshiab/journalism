...
exports.default = mortgageInsurancePremium;
 ...
 * @category Finance
 */
function mortgageInsurancePremium(purchasePrice, downPayment) {
    ...
    if (downPayment < downPaymentMin) {
        throw new Error(`The down payment is less than the minimum required down payment (${downPayment} < ${downPaymentMin}).`);
    }
