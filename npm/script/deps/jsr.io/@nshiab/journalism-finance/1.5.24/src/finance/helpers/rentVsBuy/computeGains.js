...
exports.default = computeGains;
const getTfsaContribution_js_1 = __importDefault(require("./getTfsaContribution.js"));
// Fast 2-decimal rounding via pure arithmetic (avoids toFixed string allocations).
const r2 = (x) => Math.round(x * 100) / 100;
function computeGains(year, persona, mortgagePayment, monthlyMarketReturnRate, totalMonthlyExpenses, maxMonthlyExpenses, tfsaContributions, couple, annualInvestmentFeeRate) {
    ...
    if (tfsaContributions && monthlySavings > 0) {
        let tfsaRoom = (0, getTfsaContribution_js_1.default)(year, couple
