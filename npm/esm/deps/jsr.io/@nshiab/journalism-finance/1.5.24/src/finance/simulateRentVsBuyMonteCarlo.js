import { prettyDuration } from "../../../../journalism-format/1.1.7/src/index.js";
import simulateRentVsBuy from "./simulateRentVsBuy.js";
import getMinimumDownPayment from "./getMinimumDownPayment.js";
import { getCorrelatedShocks, stepCir, stepGbm, } from "../../../../journalism-statistics/1.5.2/src/index.js";
import randNormal from "./helpers/rentVsBuy/randNormal.js";
...
function simulateRentVsBuyMonteCarlo(parameters, options = {}) {
    ...
    const downPaymentMin = getMinimumDownPayment(parameters.stochasticParameters.appreciation.initialValue);
    ...
    for (let i = 0; i < parameters.iterations; i++) {
        ...
        for (let m = 0; m < nbMonths; m++) {
            ...
            // 0-9 are GBM
            paths[0][m + 1] = stepGbm(paths[0][m], parameters.stochasticParameters.employmentIncome.mu, parameters.stochasticParameters.employmentIncome.sigma, dt, X[0]);
            paths[1][m + 1] = stepGbm(paths[1][m], parameters.stochasticParameters.market.mu, parameters.stochasticParameters.market.sigma, dt, X[1]);
            paths[2][m + 1] = stepGbm(paths[2][m], parameters.stochasticParameters.rent.mu, parameters.stochasticParameters.rent.sigma, dt, X[2]);
            paths[3][m + 1] = stepGbm(paths[3][m], parameters.stochasticParameters.ownerInsurance.mu, parameters.stochasticParameters.ownerInsurance.sigma, dt, X[3]);
            paths[4][m + 1] = stepGbm(paths[4][m], parameters.stochasticParameters.renterInsurance.mu, parameters.stochasticParameters.renterInsurance.sigma, dt, X[4]);
            paths[5][m + 1] = stepGbm(paths[5][m], parameters.stochasticParameters.maintenance.mu, parameters.stochasticParameters.maintenance.sigma, dt, X[5]);
            paths[6][m + 1] = stepGbm(paths[6][m], parameters.stochasticParameters.propertyTax.mu, parameters.stochasticParameters.propertyTax.sigma, dt, X[6]);
            paths[7][m + 1] = stepGbm(paths[7][m], parameters.stochasticParameters.condoFee.mu, parameters.stochasticParameters.condoFee.sigma, dt, X[7]);
            paths[8][m + 1] = stepGbm(paths[8][m], parameters.stochasticParameters.appreciation.mu, parameters.stochasticParameters.appreciation.sigma, dt, X[8]);
            paths[9][m + 1] = stepGbm(paths[9][m], parameters.stochasticParameters.sellingFixedFees.mu, parameters.stochasticParameters.sellingFixedFees.sigma, dt, X[9]);
            // 10-15 are CIR
            paths[10][m + 1] = stepCir(paths[10][m], parameters.stochasticParameters.fiveYearInterestRates.a, parameters.stochasticParameters.fiveYearInterestRates.b, parameters.stochasticParameters.fiveYearInterestRates.sigma, dt, X[10]);
            paths[11][m + 1] = stepCir(paths[11][m], parameters.stochasticParameters.fourYearInterestRates.a, parameters.stochasticParameters.fourYearInterestRates.b, parameters.stochasticParameters.fourYearInterestRates.sigma, dt, X[11]);
            paths[12][m + 1] = stepCir(paths[12][m], parameters.stochasticParameters.threeYearInterestRates.a, parameters.stochasticParameters.threeYearInterestRates.b, parameters.stochasticParameters.threeYearInterestRates.sigma, dt, X[12]);
            paths[13][m + 1] = stepCir(paths[13][m], parameters.stochasticParameters.twoYearInterestRates.a, parameters.stochasticParameters.twoYearInterestRates.b, parameters.stochasticParameters.twoYearInterestRates.sigma, dt, X[13]);
            paths[14][m + 1] = stepCir(paths[14][m], parameters.stochasticParameters.oneYearInterestRates.a, parameters.stochasticParameters.oneYearInterestRates.b, parameters.stochasticParameters.oneYearInterestRates.sigma, dt, X[14]);
            paths[15][m + 1] = stepCir(paths[15][m], parameters.stochasticParameters.variableInterestRates.a, parameters.stochasticParameters.variableInterestRates.b, parameters.stochasticParameters.variableInterestRates.sigma, dt, X[15]);
        }
        ...
        winnersCategory[i] = WINNER_CATEGORIES.indexOf(w.category);
    }
    if (start) {
