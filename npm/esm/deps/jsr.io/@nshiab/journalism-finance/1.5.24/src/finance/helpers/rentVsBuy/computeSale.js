...
export default function computeSale(monthIndex, persona, employmentIncome, mortgagePayment, currentPostedRates, mortgageType, winVariableOnly, numberOfMonths, province, couple, salesTaxMultiplier = 0) {
