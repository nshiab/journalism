 ...
 */
export type StochasticVariable = "employmentIncome" | "market" | "rent" | "ownerInsurance" | "renterInsurance" | "maintenance" | "propertyTax" | "condoFee" | "appreciation" | "sellingFixedFees" | "fiveYearInterestRates" | "fourYearInterestRates" | "threeYearInterestRates" | "twoYearInterestRates" | "oneYearInterestRates" | "variableInterestRates";
/**
 ...
 * ```
 */
export default function getRentVsBuyCholeskyMatrix(data?: StochasticData, options?: {
    jitter?: number;
}): number[][];
//# sourceMappingURL=getRentVsBuyCholeskyMatrix.d.ts.map