import { getCholeskyMatrix, getCorrelationMatrix, } from "../../../../../../journalism-statistics/1.5.2/src/index.js";
/**
 ...
 * ```
 */
export default function getRentVsBuyCholeskyMatrix(data, options = {}) {
    const numVars = 16;
    if (!data) {
