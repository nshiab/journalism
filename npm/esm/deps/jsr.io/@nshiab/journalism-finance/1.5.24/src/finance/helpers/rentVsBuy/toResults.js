...
export default function toResults(category, persona, results, monthIndex, numberOfMonths, winVariableOnly, mortgagePayment, employmentIncome, inflationMultiplier, onRecord, winVariable, groups) {
