import { arraysToData } from "../../../../journalism-format/1.1.7/src/index.js";
/**
 ...
 * @category Finance
 */
export default async function getYahooFinanceData(symbol, startDate, endDate, variable, interval, useBrowser = false) {
