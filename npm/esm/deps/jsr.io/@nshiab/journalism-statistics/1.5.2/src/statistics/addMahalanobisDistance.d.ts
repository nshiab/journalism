 ...
 * @category Statistics
 */
export default function addMahalanobisDistance<T extends Record<string, unknown>>(origin: Record<string, number>, data: T[], options: {
    similarity: true;
    matrix?: number[][];
}): (T & {
    mahaDist: number;
...
//# sourceMappingURL=addMahalanobisDistance.d.ts.map