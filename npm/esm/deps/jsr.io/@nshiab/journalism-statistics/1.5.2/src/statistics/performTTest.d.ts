 ...
 * @category Statistics
 */
export default function performTTest<T extends Record<string, unknown>>(sampleData: T[], variableKey: keyof T, hypothesizedMean: number, options?: {
...
//# sourceMappingURL=performTTest.d.ts.map