import { getClosest } from "../../../../journalism-geo/1.0.6/src/index.js";
 ...
 * @category Weather
 */
export default async function getEnvironmentCanadaRecords(locations, variable, dateRange, options = {}) {
    ...
    for (const location of locations) {
        ...
        const closestStation = getClosest(lon, lat, stationsIdsAndCoordinates, (d) => d.lon, (d) => d.lat, {
            addDistance: true,
            decimals: 0,
        });
        if (options.verbose) {
