 ...
 * @category Formatting
 */
export default async function reencode(inputFilePath, outputFilePath, fromEncoding, toEncoding, options = {}) {
    ...
    try {
        ...
        await pipeline(readStream, iconv.decodeStream(fromEncoding), iconv.encodeStream(toEncoding), writeStream);
    }
    catch (err) {
