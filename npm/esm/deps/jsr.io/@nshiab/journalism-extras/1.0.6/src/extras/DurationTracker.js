...
export default class DurationTracker {
    ...
    constructor(length, options = {}) {
        ...
        Object.defineProperty(this, "iterationDurations", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "currentStart", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "currentEnd", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    log() {
        ...
        const averageDuration = Math.round(this.iterationDurations.reduce((a, b) => a + b, 0) /
            this.iterationDurations.length);
        const remainingTime = averageDuration *
            (this.length - this.iterationDurations.length);
        console.log(`${this.prefix}${prettyDuration(0, { end: remainingTime })}${this.suffix}`);
    }
}
