 ...
 * @category Formatting
 */
export default function reencode(inputFilePath: string, outputFilePath: string, fromEncoding: string, toEncoding: string, options?: {
    bufferSize?: number;
    addBOM?: boolean;
}): Promise<void>;
//# sourceMappingURL=reencode.d.ts.map