...
export default function formatDate(date, format, options = {}) {
    ...
    if (mergedOptions.style === "cbc") {
        dateFormatted = dateToCBCStyle(dateFormatted, mergedOptions.abbreviations, mergedOptions.threeLetterMonth);
    }
    else if (mergedOptions.style === "rc") {
        dateFormatted = dateToRCStyle(dateFormatted, mergedOptions.abbreviations, mergedOptions.threeLetterMonth);
    }
