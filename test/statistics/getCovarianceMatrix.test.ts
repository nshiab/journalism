...
describe("getCovarianceMatrix", () => {
    it("should return a 2x2 covariance matrix", () => {
    ...
    it("should return a 2x2 inverted covariance matrix", () => {
        const twoVariables = data.map((d) => [d["fixed acidity"], d.alcohol])
    ...
    it("should return a 3x3 covariance matrix", () => {
    ...
    it("should return a 3x3 inverted covariance matrix", () => {
        const threeVariables = data.map((d) => [
            d["fixed acidity"],
            d["residual sugar"],
            d.alcohol,
    ...
    it("should return a 4x4 covariance matrix", () => {
        ...
        assert.deepStrictEqual(matrix, [
            [
                0.7119681970550005, 0.3809440223475775, 0.0006695405312093783,
                -0.12550719251309772,
            ],
            [
            ...
            [
                0.0006695405312093783, 0.012724566900994994,
                0.000008943697841212739, -0.00287084411696803,
            ],
            [
                -0.12550719251309772, -2.8121660685891356, -0.00287084411696803,
                1.514117788841716,
            ],
        ])
    })
    it("should return a 4x4 inverted covariance matrix", () => {
        const fourVariables = data.map((d) => [
            d["fixed acidity"],
            d["residual sugar"],
            d.density,
        ...
        assert.deepStrictEqual(matrix, [
            ...
            [
                0.29548258210193046, 0.2508884395460819, -566.2813827046937,
                -0.583230998661561,
            ],
            [
                -857.0948891407204, -566.2813827046937, 1587280.2449344082,
                1886.7655549874191,
            ],
            [
                -0.9196015969508056, -0.583230998661561, 1886.7655549874191,
                3.078393760864504,
            ],
        ])
    })
