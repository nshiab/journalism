...
Deno.test("should add the Mahalanobis distance and the similarity with two variables (example from doc)", () => {
  const data = [
    { "fixed acidity": 6.5, alcohol: 13 },
    { "fixed acidity": 7.1, alcohol: 12.2 },
    { "fixed acidity": 7.3, alcohol: 11.4 },
...
Deno.test("should add the Mahalanobis distance with a precomputed matrix with two variables (example from doc)", () => {
  const data = [
    { "fixed acidity": 6.5, alcohol: 13 },
    { "fixed acidity": 7.1, alcohol: 12.2 },
    { "fixed acidity": 7.3, alcohol: 11.4 },
...
Deno.test("should add the Mahalanobis distance with two variables", () => {
...
Deno.test("should add the Mahalanobis distance with three variables", () => {
...
Deno.test("should add the Mahalanobis distance with four variables", () => {
